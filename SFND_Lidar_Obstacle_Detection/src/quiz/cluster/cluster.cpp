...
int main ()
{
	...
	// Create data
	std::vector<std::vector<float>> points = { {-6.2,7,1}, {-6.3,8.4,2}, {-5.2,7.1,3}, {-5.7,6.3,4}, {7.2,6.1,5}, {8.0,5.3,4}, {7.2,7.1,3}, {0.2,-7.1,2}, {1.7,-6.9,1}, {-1.2,-7.2,2}, {2.2,-8.9,3} };
    ...
    for (int i=0; i<points.size(); i++) 
  	...
  	std::vector<int> nearby = tree->search({-6,7,2},3.0);
